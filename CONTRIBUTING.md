...
issue](https://github.com/hopetambala/data4good-django/issues) before anybody
...
Short answer: with pull requests to the Data4Good-Django repository.

All decisions affecting Data4Good-Django follow the same 3 steps:
...
* 2) Be available to anyone with questions, bug reports, criticism etc. on Data4Good-Django.
